...
//  (ImGuiBackendFlags_HasMouseCursors). Disable with 'io.ConfigFlags |= ImGuiConfigFlags_NoMouseCursorChange'.
...
//  2026-01-28: Inputs: Minor optimization not submitting gamepad input if packet number has not changed (reworked from
//  2025-09-23 attempt). (#9202, #8556) 2025-12-03: Inputs: handle WM_IME_CHAR/WM_IME_COMPOSITION messages to support
//  Unicode inputs on MBCS (non-Unicode) Windows. (#9099, #3653, #5961) 2025-10-19: Inputs: Revert previous change to
//  allow for io.ClearInputKeys() on focus-out not losing gamepad state. 2025-09-23: Inputs: Minor optimization not
//  submitting gamepad input if packet number has not changed. 2025-09-18: Call platform_io.ClearPlatformHandlers() on
//  shutdown. 2025-04-30: Inputs: Fixed an issue where externally losing mouse capture (due to e.g. focus loss) would
//  fail to claim it again the next subsequent click. (#8594) 2025-03-10: When dealing with OEM keys, use scancodes
//  instead of translated keycodes to choose ImGuiKey values. (#7136, #7201, #7206, #7306, #7670, #7672, #8468)
